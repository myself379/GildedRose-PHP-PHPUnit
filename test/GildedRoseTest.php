...
{
    /**
     *  If you want to be hard core, you can delete all the tests below and rewrites them base on the rules in README.md
     *  In the spirit of refactoring, make it all green before proceed to refactoring phase.
     *
     *  But, you're free to use the below tests as a starting point.
     *
     * Good luck!
     */
    ...
    public function test_sulfuras_quality_remain_at_80_and_sellin_unchanged()
    {
        $item = GildedRose::type('Sulfuras, Hand of Ragnaros', 80, 10);
        $item->updateQuality();
    ...
    {
        $item = GildedRose::type('Elixir of the Mongoose', 10, 0);
        $item->updateQuality();
    ...
    {
        $item = GildedRose::type('Elixir of the Mongoose', 10, -1);
        $item->updateQuality();
        $this->assertEquals($item->quality, 8);
